...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T2 — Estado estruturado, memória e reconciliação | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T2.md` | em execução | G1 aprovado; G2 — estado estruturado funcional | 2026-04-23 | PR-T2.2 executada | PR-T2.3 |
