...
Este índice está subordinado ao A00, A01, A02 e ao `CONTRACT_EXECUTION_PROTOCOL.md`.
...
| 2 | Speech Engine e Surface Única | `schema/contracts/active/CONTRATO_ATENDENTE_ESPECIALISTA_MCMV_GOVERNANCA_ESTRUTURAL.md` | aberto | 2026-04-21 | abertura do contrato da frente sucessora do Core | — | — | PR1 textual mínima da atendente especialista MCMV |
