...
| 5 | Áudio e Multimodalidade | `schema/contracts/active/CONTRATO_AUDIO_E_MULTIMODALIDADE_2026-04-21.md` | em execução | 2026-04-21 | PR 45 — abertura contratual da Frente 5 | PR 47 — convergência áudio → pacote semântico → extração estruturada | — | Contrato da Frente 6 — Meta/WhatsApp |
