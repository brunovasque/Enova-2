...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T1 — Constituição do agente e contrato cognitivo canônico | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T1.md` | aberto | G1 — contrato cognitivo aprovado | 2026-04-23 | PR-T1.3 — taxonomia oficial | PR-T1.3 |
