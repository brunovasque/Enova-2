...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T7 — Shadow, canary, cutover e rollback | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T7.md` | **em execução** — PR-T7.4 executada; próxima PR-T7.5 | G6 APROVADO; G7 — go-live controlado (bloqueado até PR-T7.R) | 2026-04-29 | PR-T7.5 — Cutover parcial ou total governado |
