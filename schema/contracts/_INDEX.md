...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T3 — Policy engine v1 e guardrails declarativos | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T3.md` | em execução | G2 aprovado; G3 — policy engine funcional | 2026-04-24 | PR-T3.5 executada | PR-T3.R |
