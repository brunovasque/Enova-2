...
| 3 | Contexto, Extração e Memória Viva | `schema/contracts/active/CONTRATO_CONTEXTO_EXTRACAO_E_MEMORIA_VIVA.md` | em execução | 2026-04-21 | PR 35 — abertura contratual da Frente 3 | PR 36 — schema base de contexto e extração estruturada | — | Contrato da Frente 4 — Supabase Adapter e Persistência |
