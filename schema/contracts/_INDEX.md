...
| 4 | Supabase Adapter e Persistência | `schema/contracts/active/CONTRATO_SUPABASE_ADAPTER_E_PERSISTENCIA.md` | em execução | 2026-04-21 | PR 40 — abertura contratual da Frente 4 | PR 42 — adapter base de leitura/escrita canônica | — | PR 43 — política de merge/update/consistência |
