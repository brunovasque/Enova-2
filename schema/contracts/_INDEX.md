...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T4 — Orquestrador de turno LLM-first | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T4.md` | em execução | G3 aprovado; G4 — orquestrador funcional | 2026-04-25 | PR-T4.2 | PR-T4.3 |
