...
|------|----------------|--------|------|------------------|----------|--------------------------|
| T3 — Policy engine v1 e guardrails declarativos | `schema/contracts/active/CONTRATO_IMPLANTACAO_MACRO_T3.md` | em execução | G2 aprovado; G3 — policy engine funcional | 2026-04-24 | PR-T3.4 executada | PR-T3.5 |
...
- 2026-04-25 — PR-T3.4 executada. T3_VETO_SUAVE_VALIDADOR.md criado: VetoSuaveRecord com 5 tipos de risco, 3 resoluções, escalada condicional para bloqueio, ciclo de vida e acknowledged; extensão PolicyDecisionSet com soft_vetos[] e invariante de separação; validador posicionado como passo 4 de 6 no pipeline de turno; ValidationContext + LLMResponseMeta + ValidationResult com safe_fields e blocked_fields; checklist VC-01..VC-08 (8 itens — 5 critical, 3 advisory); lógica de decisão agregada APPROVE/REJECT/REQUIRE_REVISION/PREVENT_PERSISTENCE; 10 cenários SC-VS-01..10; validação cruzada T3.1/T3.2/T3.3/T2; 10 anti-padrões AP-VS-01..10; 10 regras RC-VS-01..10; todas as 5 microetapas T3 cobertas. PR-T3.5 desbloqueada. Próximo passo: PR-T3.5.
