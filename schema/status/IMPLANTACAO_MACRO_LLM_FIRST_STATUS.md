...
Gate atual: **G9 — ABERTO** — contrato T9 aberto 2026-05-01; T9.1/T9.2/T9.3/T9.4/T9.5/T9.6-DIAG/T9.6-IMPL/T9.7/T9.8-DIAG/T9.8-IMPL/T9.9-DIAG/T9.9-IMPL/T9.10-DIAG/T9.10-IMPL/T9.11 CONCLUÍDAS; **T9.12-DIAG CONCLUÍDA** (2026-05-02) — 5 bloqueadores identificados, 2 tabelas prontas (crm_lead_state→enova_state, crm_leads→crm_lead_meta), 2 diferidas (crm_turns + crm_facts aguardam Vasques); próxima PR autorizada: **T9.12 — IMPL Supabase write real (CRM/memória/stage)**.
