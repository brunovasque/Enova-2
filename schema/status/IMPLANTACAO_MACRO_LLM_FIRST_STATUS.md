...
Próxima PR autorizada: **PR-T8.12B — Execução real Meta/WhatsApp controlada** (PR-PROVA) — obrigatória antes de qualquer avanço. Requer: secrets provisionados via `wrangler secret put`, deploy Worker em ambiente test, webhook registrado no painel Meta Developers, execução de `prove:meta-controlada` em modo real com P2–P7 PASS.
