...
Gate atual: **G9 — ABERTO** — contrato T9 aberto 2026-05-01; T9.1/T9.2/T9.3/T9.4/T9.5/T9.6-DIAG/T9.6-IMPL/T9.7/T9.8-DIAG/T9.8-IMPL/T9.9-DIAG/T9.9-IMPL/T9.10-DIAG/T9.10-IMPL/T9.11/T9.12-DIAG/T9.12-IMPL CONCLUÍDAS; **T9.13-PROVA CRIADA** (2026-05-03) — harness dual-mode instalado; modo local 19/19 PASS; modo TEST real SKIP aguarda Vasques (`SUPABASE_WRITE_REAL_TEST_ENABLED=true` + credenciais); `prove:t9.13-supabase-write-real-test` adicionado ao `package.json`; `schema/proofs/T9_SUPABASE_WRITE_REAL_TEST_PROOF.md` criado; próxima PR autorizada: **T9.13B — Execução real da prova Supabase write em TEST por Vasques** (ou T9.14 se Vasques executar e confirmar PASS).
