...
Gate atual: **G9 — ABERTO** — contrato T9 aberto 2026-05-01; T9.1/T9.2/T9.3/T9.4/T9.5/T9.6-DIAG/T9.6-IMPL/T9.7/T9.8-DIAG/T9.8-IMPL/T9.9-DIAG/T9.9-IMPL/T9.10-DIAG/T9.10-IMPL/T9.11/T9.12-DIAG CONCLUÍDAS; **T9.12-IMPL CONCLUÍDA** (2026-05-02) — escrita real habilitada para crm_leads→crm_lead_meta e crm_lead_state→enova_state; crm_turns/crm_facts mantidos em writeBuffer (BLK-WRITE-02/04 — DDL não confirmado por Vasques); 32/32 smoke:supabase:write-real PASS; fallback garantido em falha de rede; secrets nunca expostos; próxima PR autorizada: **T9.12-PROVA — confirmar escrita real em Worker TEST com SUPABASE_WRITE_ENABLED=true**.
