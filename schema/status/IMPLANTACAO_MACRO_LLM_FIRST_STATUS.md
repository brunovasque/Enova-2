...
Gate atual: **G8 — em aberto** — T8 em execução; **PR-T8.16 CONCLUÍDA**; **próxima PR autorizada: PR-PROVA da T8.16** (provar com mensagem real no Worker TEST: lead criado, turno registrado, memória registrada, sem resposta WhatsApp).
